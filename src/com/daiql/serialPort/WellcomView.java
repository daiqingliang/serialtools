...
//        jFrame.setIconImage(icon);
        ...
        JLabel banben=new JLabel("Version：1.0 Powered By：daiql  2019-04-13");
        banben.setBounds(180, 390,500,50);
        banben.setFont(new Font("微软雅黑", Font.ITALIC, 22));
        jFrame.add(banben);

        JLabel thanks =new JLabel("Thanks for cyq");
        thanks.setBounds(320, 430,500,50);
        thanks.setFont(new Font("微软雅黑", Font.ITALIC, 14));
        jFrame.add(thanks);
